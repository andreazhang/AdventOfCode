...
class Scratchcards {
    companion object {
        ...
        fun getNumberOfRecursiveScratchcards(games: List<Game>): Int {
            ...
            val nextAvailableScratchcards = games.subList(1, maxWinScratchcardWithinAvailable)
            return games.size + nextAvailableScratchcards.sumOf { getNumberOfRecursiveScratchcards(listOf(it)) }
        }
